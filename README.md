...
<code>
npm config set proxy=127.0.0.1:5678<br/>
npm config set https-proxy=127.0.0.1:5678<br/>
</code>
-----<br/>
...
Manually install chrome webdriver:<br/>
